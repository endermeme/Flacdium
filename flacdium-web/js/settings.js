...
export async function initializeSettings(scrobbler, player, api, ui) {
    ...
    // Headphone database is loaded lazily when the user opens the AutoEQ section (see the
    // loadFullDatabase() call on the database tab), not eagerly at boot — the eager fetch
    // from GitHub was the single biggest startup-latency contributor.
