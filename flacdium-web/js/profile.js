...
// Cloud-profile UI elements may be absent on Flacdium (no cloud profiles) — guard binds.
...
authManager.onAuthStateChanged((user) => {
    if (viewMyProfileBtn) viewMyProfileBtn.style.display = user ? 'inline-block' : 'none';
});
